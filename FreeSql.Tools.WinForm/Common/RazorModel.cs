...
public class RazorModel
{
    ...
    public string ExportTableData(string tableName, string sql)
    {
        return new MySqlBackup(fsql.Ado.ConnectionString).ExportRowsToMarkDownString(table.Schema, tableName, sql);
    }
